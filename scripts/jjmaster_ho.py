...
class stool:
    ...
    def __init__(self):
        rospy.Subscriber("sceinaro_num", String, self.callback1)
    ...
    def callback1(self, data):
        ...
        if data.data == "adult":
            ...
            time.sleep(0.4)
            self.movebase_client(1.15,1.5,0)
            stool.turtlebot3_move=False
	...
	#시나리오: 1번 갔다가 3번
            ...
            #if stool.reset_cnt==0:
            stool.turtlebot3_move=True   
            self.movebase_client(1.5,1.5,0)
            stool.turtlebot3_move=False

        elif data.data =="test3":
            # if stool.reset_cnt==0:
            stool.turtlebot3_move=True   
            self.movebase_client(1.9,1.5,0)
            stool.turtlebot3_move=False
	...
	#2번 시나리오: 2번, 4번
            ...
            #if stool.reset_cnt==0:
                stool.turtlebot3_move=True   
                self.movebase_client(-0.2,0.9,0)
                stool.turtlebot3_move=False

        elif data.data =="test6":
            #if stool.reset_cnt==0:
                stool.turtlebot3_move=True   
                self.movebase_client(0,0,0)
                stool.turtlebot3_move=False
